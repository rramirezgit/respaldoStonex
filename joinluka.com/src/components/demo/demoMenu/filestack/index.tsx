  ...
  return (
    <Box className={styles.container} onClick={handleClick}>
      <Box component={"figure"} className={styles.figure}>
        <Image src={supportImg.plus} alt="Add" />
      </Box>
      <Box>
        <Typography className={styles.title}>Upload File</Typography>
        <Typography className={styles.subtitle}>Add up to 2 GB</Typography>
      </Box>
    </Box>
  );
};
